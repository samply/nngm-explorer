...
<main>
	...
	<div class="componentBox">
		<lens-chart title="Gender distribution" catalogueGroupCode="gender" chartType="pie" />
	</div>
	...
	<h2>Catalogue</h2>
	<div class="componentBox">
		<lens-catalogue texts={catalogueText} toggle={{ collapsable: true, open: catalogueopen }} />
	</div>
