export const alias = new Map<string, string>([
	...
	['BBMRI_SampleMaterialType', 'https://fhir.bbmri.de/CodeSystem/SampleMaterialType'], //specimentype
	['BBMRI_StorageTemperature', 'https://fhir.bbmri.de/CodeSystem/StorageTemperature'],
	[
		'BBMRI_SmokingStatus',
